...
//     ANSWER NO 32;
let CurrentUsers: string[] = ["Raza" , "Hasan" , "Shoaib" , "Kashan" , "Ali"]
let newUsers: string[] = ["raza" , "shahzaib" , "Ali" , "nawaz" , "Kashan", "mahid" , "nehal", "Shoaib" ]
 
function checkUsers(currentUsers : string[], newUsers:string[]):void
{
